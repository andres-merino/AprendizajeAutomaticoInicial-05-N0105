...
% Máximo 3 resultados
\begin{itemize}[leftmargin=*]
    \item Seleccionar métricas y umbrales de decisión según el contexto, el desbalance de clases y el costo de los distintos tipos de error.
...
\begin{itemize}[leftmargin=*]
    ...
    También se contrastarán las curvas ROC y precisión-recall, el efecto del desbalance de clases y la calibración de las probabilidades para seleccionar métricas y umbrales coherentes con el contexto.
    ...
    \begin{itemize}
        \item Aumenta el conjunto de datos con más muestras y observa cómo cambian las métricas de evaluación.
        \item Cambia el umbral y calcula las nuevas métricas de evaluación. Observa cómo varían. Apunta algunos datos para diferentes umbrales y luego colócalos en un plano cartesiano (FPR vs TPR).
        \item Compara las curvas ROC y precisión-recall en una versión balanceada y otra desbalanceada del conjunto de datos. Justifica cuál representa mejor el desempeño en cada caso.
        \item Elige un umbral para un caso de salud pública y explica el compromiso entre falsos negativos, falsos positivos y calibración de las probabilidades.
    \end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Experimentación:} 
    \begin{itemize}
        \item Multiplica los valores de y por un factor constante (por ejemplo, 10) y observa cómo cambian las métricas de evaluación. ¿Qué métricas son sensibles a la escala de los datos?
    \end{itemize}
\end{itemize}
