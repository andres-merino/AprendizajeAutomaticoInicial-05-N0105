...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Implementación en Python:} Los estudiantes accederán a un cuaderno de Jupyter previamente preparado.
    \begin{quote}
        Enlace al cuaderno: \href{https://github.com/andres-merino/AprendizajeAutomaticoInicial-05-N0105/blob/main/2-Notebooks/06-2-SVD.ipynb}{06-2-SVD.ipynb}.
    \end{quote}
...
\begin{itemize}
    \item La siguiente sesión se realizará un taller de implementación.
    \item La sesión subsiguiente se tendrá evaluación.
    \item Ver el video \href{https://youtu.be/NyhnBI2aJmQ?si=XLyDJCydPYe1e2T1}{APRENDIZAJE NO SUPERVISADO EN MACHINE LEARNING}.
\end{itemize}
