...
\begin{itemize}[leftmargin=*]
    ...
    \item Construir un flujo reproducible de preprocesamiento y partición, ajustando las transformaciones solo con los datos de entrenamiento para evitar fuga de información.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    Se utilizará el documento \href{https://andres-merino.github.io/AprendizajeAutomaticoInicial-05-N0105/2-Resumenes/Resumen03.pdf}{Resumen03.pdf}
    \item \textbf{Implementación en Python:} Los estudiantes accederán a un cuaderno de Jupyter previamente preparado.
    \begin{quote}
        Enlace al cuaderno: \href{https://github.com/andres-merino/AprendizajeAutomaticoInicial-05-N0105/blob/main/2-Notebooks/03-1-Procesado-Datos.ipynb}{03-1-Procesado-Datos.ipynb}.
    \end{quote}
...
\begin{itemize}[leftmargin=*]
    ...
    Se presentará la necesidad de particionar conjuntos de datos, incluyendo el uso de particiones estratificadas cuando la variable objetivo esté desbalanceada.
    \item \textbf{Flujo reproducible y prevención de fuga de información:}
    Se organizarán la imputación, codificación y normalización en un \textit{Pipeline} y, cuando existan variables de distinto tipo, en un \textit{ColumnTransformer}. Estas transformaciones se ajustarán únicamente con el conjunto de entrenamiento y luego se aplicarán a validación o prueba.
    \item \textbf{Implementación en Python:} Los estudiantes accederán a un cuaderno de Jupyter previamente preparado.
    \begin{quote}
...
\paragraph{Tarea:} 
    Realizar el procesamiento de datos necesario para el conjunto seleccionado en la clase anterior y subirlo al repositorio de GitHub.
...
\begin{enumerate}[leftmargin=*]
    ...
    \item ¿Realizar one-hot encoding agrega colinealidad a las características? Ver: \href{https://blog.dailydoseofds.com/p/the-most-overlooked-problem-with}{The Problem With One-Hot Encoding}
\end{enumerate}
    
\paragraph{Para la próxima clase:} 
    Se debe tener el conjunto de datos preprocesado y listo en el repositorio.
