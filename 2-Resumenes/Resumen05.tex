...
Consideremos un problema de clasificación binaria $\func{f}{X}{\{0,1\}}$
y un modelo de clasificación $\func{\hat{f}}{X}{\{0,1\}}$ que intenta aproximar a $f$. Además, sea un conjunto de datos $D = \{(x_i,y_i)\}_{i=1}^n$ el conjunto de datos utilizado para evaluar el desempeño del modelo, donde $y_i = f(x_i)$.
