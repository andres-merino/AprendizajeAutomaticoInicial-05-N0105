...
\begin{enumerate}[leftmargin=*]
    ...
    \end{enumerate}
    \item Visualiza el siguiente video: \href{https://youtu.be/aircAruvnKk?si=vFg4G6iUMV9GdcNN}{¿Qué es una Red Neuronal? (3Blue1Brown)}
    ...
    \end{enumerate}
    \item Visualiza el siguiente video: \href{https://youtu.be/IHZwWFHWa-w?si=U9QD1W0kRQhPWaV9}{Descenso de Gradiente (3Blue1Brown)}
