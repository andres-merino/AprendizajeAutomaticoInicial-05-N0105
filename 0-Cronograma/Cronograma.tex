...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Criterio 3.1}
        \begin{itemize}[leftmargin=*]
            ...
            \item \textbf{Exposición integradora (40\%):} Consistirá en la lectura y presentación de un artículo científico, con énfasis en el análisis del componente no supervisado y su relación con el problema estudiado.
        \end{itemize}
    \item \textbf{Criterio 3.2}
        \begin{itemize}[leftmargin=*]
            ...
            \item \textbf{Exposición integradora (40\%):} Consistirá en la lectura y presentación del mismo artículo científico, con énfasis en el análisis del componente supervisado, sus resultados y limitaciones.
        \end{itemize}
\end{itemize}

La exposición integradora es un único producto que aporta evidencia diferenciada para los criterios 3.1 y 3.2; cada criterio se valora con el énfasis descrito en su apartado.
...
2	&		&	2-nov	&		&	Feriado	\\	\rowcolor{verde!50}
	...
	&		&	5-nov	&	Taller de implementación: preprocesamiento y evaluación supervisada	&		\\ \midrule
3	&		&	9-nov	&	Reducción de Dimensionalidad y Extracción de Características	&		\\	
	&		&	10-nov	&	Introducción al Aprendizaje No Supervisado	&		\\	\rowcolor{celeste!50}
	&		&	11-nov	&	Cuestionario en línea 1 (Criterio 1.1)	&	Evaluación	\\	
	&		&	12-nov	&	Algoritmos de Agrupamiento Jerárquico	&	Envío de la Videoexp 1 (Criterio 1.2)	\\ \midrule
4	&		&	16-nov	&	Agrupamiento k-Means	&		\\
	&		&	17-nov	&	Evaluación de modelos de agrupamiento	&	Hito 3 del Reto 1; entrega final: 20-nov	\\	\rowcolor{celeste!50}
	&		&	18-nov	&	Cuestionario en línea 2 (Criterio 1.2)	&	Evaluación	\\	\rowcolor{celeste!50}
	&		&	19-nov	&	Examen 1 (Criterio 2.1)	&	Entrega de la Videoexp 1 (Criterio 1.2)	\\ \midrule
5	&		&	23-nov	&	Algoritmo k-Nearest Neighbors	&	Envío de la Videoexp 2 (Criterio 1.3)	\\
	&		&	24-nov	&	Máquinas de Vectores Soporte (SVM)	&	Envío del Reto 2 (Criterio 3.2)	\\
	&		&	25-nov	&	Ajuste y Optimización de SVM	&		\\
...
7	&		&	7-dic	&	Árboles de Decisión	&		\\	
	...
	&		&	9-dic	&	Validación cruzada y búsqueda de hiperparámetros	&	Entrega de la Videoexp 2 (Criterio 1.3)	\\	\rowcolor{celeste!50}
	&		&	10-dic	&	Cuestionario en línea 3 (Criterio 1.3)	&	Evaluación	\\ \midrule
8	&		&	14-dic	&	Taller de optimización, persistencia y reproducibilidad de modelos	&		\\	\rowcolor{celeste!50}
	&		&	15-dic	&	Examen 2 (Criterio 2.2)	&	Evaluación	\\	\rowcolor{celeste!50}
	&		&	16-dic	&	Exposiciones	&	Entrega del Reto 2 (Criterio 3.2)	\\	\rowcolor{celeste!50}
	&		&	17-dic	&	Exposiciones, retroalimentación y cierre del curso	&		\\ \midrule
\end{longtable}
\end{center}
\end{landscape}
