...
\begin{enumerate}[leftmargin=*, label={\textbf{Hito \arabic*.}}]
    \item \textbf{9-nov:} selección inicial de variables y plan justificado de preprocesamiento.
    \item \textbf{12-nov:} propuesta de algoritmos de agrupamiento y técnica de reducción de dimensiones.
    \item \textbf{17-nov:} borrador de resultados, visualizaciones y métricas de calidad de los agrupamientos.
    \item \textbf{20-nov:} entrega final del notebook y del informe divulgativo.
\end{enumerate}
...
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
    ...
    \item \textbf{Presentación y diseño (2 puntos)}
    \begin{itemize}[leftmargin=*]
        \item Diseño profesional y organizado con secciones bien definidas (1 punto).
        \item Uso de gráficos y tablas adecuadamente formateados (1 punto).
    \end{itemize}
\end{enumerate}
